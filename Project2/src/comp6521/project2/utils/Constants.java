...
public class Constants {
	...
	/*
	 * public static final String INPUT_FILE1 =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\t1.txt"; public static
	 * final String INPUT_FILE2 =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\t2.txt"; public static
	 * final String NESTEDJOIN_OUTPUT_FILE =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\output.txt"; public
	 * static final String OUTPUT_FILE1 =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\output1.txt"; public
	 * static final String OUTPUT_FILE2 =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\output2.txt"; public
	 * static final String MERGED_OUTPUT1 =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\mergedOutput1.txt";
	 * public static final String MERGED_OUTPUT2 =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\mergedOutput2.txt";
	 * public static final String FINAL_SORT_JOIN_OUTPUT =
	 * "A:\\CodingStuff\\git\\Wontons\\Project2\\resources\\finalsortjoin.txt";
	 */
	...
	public static final int TUPPLES_IN_BUFFER_T1_NESTED_JOIN = (int) ((0.33)
			* ((double) MAIN_MEMORY_SIZE / TUPLE_SIZE_IN_BYTES_T1) * ((double) MEMORY_UTILIZATION / 100));

	public static final int TUPPLES_IN_BUFFER_T2_NESTED_JOIN = (int) ((0.33)
			* ((double) MAIN_MEMORY_SIZE / TUPLE_SIZE_IN_BYTES_T2) * ((double) MEMORY_UTILIZATION / 100));

	public static final int TUPPLE_FOR_JOINED_OUTPUT = (int) (((0.33) * ((double) MAIN_MEMORY_SIZE)
