...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Sorted bag1 after : "+(end-start)/1_000_000_000);
		//file 2
		start = System.nanoTime();
		int noOfTuplesInR2 = sort(inputFile2,outputFile2);
		end = System.nanoTime();
		System.out.println("Sorted bag2 after : "+(end-start)/1_000_000_000);
		
		start = System.nanoTime();
		File sortedFile1 = merge(noOfTuplesInR1,outputFile1,intermediateOutputFile1);
		end = System.nanoTime();
		System.out.println("Merged bag1 after : "+(end-start)/1_000_000_000);
		
		
		start = System.nanoTime();
		File sortedFile2 = merge(noOfTuplesInR2,outputFile2,intermediateOutputFile2);
		end = System.nanoTime();
		System.out.println("Merged bag2 after : "+(end-start)/1_000_000_000);
		...
		System.out.println("\n\n\nNow performing bag difference\nnoOfTuplesInR1: "+noOfTuplesInR1+"\nnoOfTuplesInR2: "+noOfTuplesInR2);
		
		start = System.nanoTime();
		performBagDifference(sortedFile1,noOfTuplesInR1,sortedFile2,noOfTuplesInR2,finalOutput);
		end = System.nanoTime();
		System.out.println("Bag difference in : "+(end-start)/1_000_000_000);
	...
	private static void performBagDifference(File sortedFile1, int noOfTuplesInR1, File sortedFile2, int noOfTuplesInR2,File finalOutput) throws IOException {
		...
		while(position1<=noOfTuplesInR1) {
			...
			for(int i=0;i<sublist1.size();i++) {
				...
				System.out.println("Duplicates in file1 : "+duplicates1);
				...
				System.out.println("Duplicates in file2 : "+duplicates2);
				System.out.println("*******************************************");
	...
	private static File merge(int noOfTuples,File file, File intermediateFile) throws IOException 
	{
		...
		for(int i=1;i<=noOfPasses;i++) {
			System.out.println("Executing Pass "+i);
